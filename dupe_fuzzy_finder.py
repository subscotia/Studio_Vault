#This script will:
#- Compare only tools of a specific type (like "Instrument")
#- Fuzzy match on key fields (e.g. developer + name) using similarity scoring
#- Report all near-duplicates above a configurable threshold
#- Save results to /logs/fuzzy_matches_log.csv for your review
#This is pure detective work: it doesn’t fix or merge anything—
# just lays out the fuzzy lookalikes for your review.
# Think of it like casting light across a library shelf and spotting the near-twins.
