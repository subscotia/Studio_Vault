...
PAGES_TO_MONITOR = [
    {
        ...
        "local_file": Path("/ref/Airwindopedia.md"),
    ...
    },
    {
        ...
        "local_file": Path("/ref/Acustica Audio Acqua Plugins Guide .md"),
    ...
    },
    {
        ...
        "local_file": Path("/ref/Acustica Audio Acqua Recommendations.md"),
    ...
    },
    {
        ...
        "local_file": Path(
            "/ref/Unofficial Acustica Audio Acqua Master Plugins List.md"),
        "content_selector": "#articleContent"
    }
]

# The file where we store the last known hashes of the pages.
SNAPSHOT_FILE = Path("../data/page_snapshots.json")
