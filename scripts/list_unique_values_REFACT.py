...
REF_DIR = Path("../ref")
OUTPUT_FILE = REF_DIR / "families-refct.txt"
...
def main():
    ...
    for entry in data:
        # Get the list of families from the entry.
    ...
    # Write the sorted, unique families to the output file.
    # Each fam is wrapped in quotes and placed on a new line.
    OUTPUT_FILE.write_text("\n".join(f'"{tag}"' for tag in sorted(families_set)), encoding="utf-8")
