...
FIELD_NAME   = "developer"     # Can be any field: "developer", "product", "type", etc.
OLD_VALUE    = "Newfangledaudio"
NEW_VALUE    = "Newfangled Audio"
OUT_FILE     = Path("xvault_wking_filling.json")  # or VAULT_FILE to overwrite
